...
public class controlador implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == menu.getBtn_eliminar()) {
            String idEliminar= JOptionPane.showInputDialog(menu, "Ingrese el id a eliminar", "Eliminar Registro", 1);        
        ...
        if (e.getSource() == menu.getBtn_salir()) {
           // bd.guardarArchivo();guardar archivo dat
           bd.guardarCSV();
           System.exit(0);
        }
    ...
    public void guardar() {
        ...
        JOptionPane.showMessageDialog(ingresar, "El estudiante " +nombre+ ", fue registrado correctamente", "Registro Estudiante", 1);
    ...
    public void eliminar(String id) {
        ...
        if (estudiante != null) {
            bd.eliminar(id);
            JOptionPane.showMessageDialog(null, "Registro eliminado correctamente", "Eliminar Registros", 1);
        }
